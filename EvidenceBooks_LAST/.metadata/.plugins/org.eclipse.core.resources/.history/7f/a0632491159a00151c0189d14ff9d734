...
public class GraphicUserInterface {
	...
	private void initialize() {
		...
		sl_panel.putConstraint(SpringLayout.EAST, lblSOWA, -929,
		...
		btnSprawdz.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					e.printStackTrace();
					JOptionPane.showMessageDialog(null,"Brak pliku Ÿród³owego lub plik jest otwarty w innym programie!");
				} catch (Exception e) {
					e.printStackTrace();
				}
				excel.getArrayListBook().clear();
		...
		btnZnajd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					textArea.setText(excel.arrayStringValue(excel.searchBook(textWyszukaj.getText(), path)));
		...
		textISBN_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					textArea.setText(excel.arrayStringValue(excel.searchBook(textISBN_1.getText(), path)));
					textISBN_1.setText(null);
				} catch (FileNotFoundException ex) {
					ex.printStackTrace();
					JOptionPane.showMessageDialog(null,"Brak pliku Ÿród³owego lub plik jest otwarty w innym programie!");
						...
						sl_panel_1.putConstraint(SpringLayout.WEST, textISBN_2, 10, SpringLayout.WEST, panel_1);
								...
								panel_1.add(textISBN_2);
										...
										panel_1.add(lblISBN_2);
												...
												textCENA.addMouseListener(new MouseAdapter() {
													@Override
													public void mouseEntered(MouseEvent arg0) {
