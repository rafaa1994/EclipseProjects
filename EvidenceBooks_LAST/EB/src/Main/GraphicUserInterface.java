...
public class GraphicUserInterface {
	...
	private void initialize() {
		...
		// ImageIcon im = new
		// ImageIcon(getClass().getResource("/Calculator.png"));
		// btnZnajd.setIcon(im);
		panel.add(btnZnajd);

		JButton btnSprawdz = new JButton("Sprawd\u017A");
		sl_panel.putConstraint(SpringLayout.NORTH, btnSprawdz, 103,
		...
		sl_panel.putConstraint(SpringLayout.WEST, btnZnajd, -32,
				SpringLayout.WEST, btnDodaj);
		sl_panel.putConstraint(SpringLayout.WEST, btnDodaj, 236,
				SpringLayout.WEST, panel);
		sl_panel.putConstraint(SpringLayout.EAST, btnSprawdz, -15,
				SpringLayout.WEST, btnDodaj);
		...
		sl_panel.putConstraint(SpringLayout.WEST, textISBN_1, 10,
				SpringLayout.WEST, panel);
		sl_panel.putConstraint(SpringLayout.NORTH, btnDodaj, 6,
				SpringLayout.SOUTH, textISBN_1);
		sl_panel.putConstraint(SpringLayout.NORTH, lblWyszukaj, 67,
				SpringLayout.SOUTH, textISBN_1);
		sl_panel.putConstraint(SpringLayout.SOUTH, lblISBN_1, -6,
				SpringLayout.NORTH, textISBN_1);
		sl_panel.putConstraint(SpringLayout.SOUTH, textISBN_1, -6,
				SpringLayout.NORTH, btnSprawdz);
		...
		sl_panel.putConstraint(SpringLayout.NORTH, lblSOWA, 476,
				SpringLayout.NORTH, panel);
		sl_panel.putConstraint(SpringLayout.WEST, lblSOWA, 0,
				SpringLayout.WEST, lblISBN_1);
		sl_panel.putConstraint(SpringLayout.SOUTH, lblSOWA, -10,
		...
		sl_panel.putConstraint(SpringLayout.SOUTH, btnZnajd, 33,
				SpringLayout.SOUTH, textWyszukaj);
		sl_panel.putConstraint(SpringLayout.WEST, textWyszukaj, 10,
				SpringLayout.WEST, panel);
		sl_panel.putConstraint(SpringLayout.NORTH, btnZnajd, 6,
				SpringLayout.SOUTH, textWyszukaj);
		sl_panel.putConstraint(SpringLayout.NORTH, textWyszukaj, 6,
				SpringLayout.SOUTH, lblWyszukaj);
		...
		sl_panel.putConstraint(SpringLayout.EAST, textISBN_1, -322,
				SpringLayout.WEST, scrollPane_1);
		sl_panel.putConstraint(SpringLayout.EAST, btnDodaj, -322,
				SpringLayout.WEST, scrollPane_1);
		sl_panel.putConstraint(SpringLayout.WEST, scrollPane_1, 627,
				SpringLayout.WEST, panel);
		sl_panel.putConstraint(SpringLayout.EAST, textWyszukaj, -322,
				SpringLayout.WEST, scrollPane_1);
		sl_panel.putConstraint(SpringLayout.EAST, btnZnajd, -322,
				SpringLayout.WEST, scrollPane_1);
		sl_panel.putConstraint(SpringLayout.NORTH, scrollPane_1, 6,
				SpringLayout.SOUTH, lblINFO);
		sl_panel.putConstraint(SpringLayout.SOUTH, scrollPane_1, -10,
				SpringLayout.SOUTH, panel);
		sl_panel.putConstraint(SpringLayout.EAST, scrollPane_1, -7,
...
//		});
		...
		sl_panel_2.putConstraint(SpringLayout.EAST, textISBN_3, -631,
		...
		sl_panel_2.putConstraint(SpringLayout.WEST, textTitle, 44,
				SpringLayout.WEST, panel_2);
		sl_panel_2.putConstraint(SpringLayout.EAST, textTitle, -765,
				SpringLayout.EAST, panel_2);
		...
		sl_panel_2.putConstraint(SpringLayout.SOUTH, lblTytu, -401,
				SpringLayout.SOUTH, panel_2);
		sl_panel_2.putConstraint(SpringLayout.NORTH, textTitle, 6,
				SpringLayout.SOUTH, lblTytu);
		sl_panel_2.putConstraint(SpringLayout.WEST, lblTytu, 44,
				SpringLayout.WEST, panel_2);
		sl_panel_2.putConstraint(SpringLayout.SOUTH, textISBN_3, -27,
		...
		sl_panel_2.putConstraint(SpringLayout.WEST, lblAutorzy, 44,
				SpringLayout.WEST, panel_2);
		sl_panel_2.putConstraint(SpringLayout.SOUTH, lblAutorzy, -319,
				SpringLayout.SOUTH, panel_2);
		...
		sl_panel_2.putConstraint(SpringLayout.NORTH, textAuthors, 6,
				SpringLayout.SOUTH, lblAutorzy);
		sl_panel_2.putConstraint(SpringLayout.WEST, textAuthors, 44,
				SpringLayout.WEST, panel_2);
		sl_panel_2.putConstraint(SpringLayout.EAST, textAuthors, -765,
				SpringLayout.EAST, panel_2);
		...
		lblPermission.setFont(new Font("Microsoft YaHei UI Light", Font.PLAIN,
				20));
		...
		textPermission.setBorder(new LineBorder(new Color(0, 102, 204)));
		textPermission.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent arg0) {
				textPermission.setBorder(new LineBorder(new Color(0, 0, 0)));
			}

			@Override
			public void mouseExited(MouseEvent arg0) {
				textPermission
						.setBorder(new LineBorder(new Color(0, 102, 204)));
			}
		});
		panel_2.add(textPermission);
		

		JButton btnUzupelnij = new JButton("Wprowad\u017A");
		sl_panel_2.putConstraint(SpringLayout.WEST, btnUzupelnij, 829,
				SpringLayout.WEST, panel_2);
		sl_panel_2.putConstraint(SpringLayout.SOUTH, btnUzupelnij, -10,
				SpringLayout.SOUTH, panel_2);
		sl_panel_2.putConstraint(SpringLayout.EAST, btnUzupelnij, -43,
				SpringLayout.EAST, panel_2);
		btnUzupelnij.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {

				{
					...
					try {
						String message = excelHandler.fillInfo(
								textTitle.getText(), textLevel.getText(),
								textAuthors.getText(), textPublisher.getText(),
								textAmount.getText(), textPrice.getText(),
								textISBN_3.getText(), textSchool.getText(),textPermission.getText(),
								path);
		...
		sl_panel_2.putConstraint(SpringLayout.EAST, btnSprawdz2, -43,
				SpringLayout.EAST, panel_2);
		...
		sl_panel_2.putConstraint(SpringLayout.WEST, label_2, 10,
				SpringLayout.WEST, panel_2);
		sl_panel_2.putConstraint(SpringLayout.SOUTH, label_2, -10,
				SpringLayout.SOUTH, panel_2);
